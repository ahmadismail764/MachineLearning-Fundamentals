...
| **SMOTE**                 | Generate _synthetic_ minority samples using feature space interpolation | Reduces overfitting vs. random oversampling; no info loss | Ignores class boundaries; may cause class overlap or introduce noise |
